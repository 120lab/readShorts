namespace readShorts.DataAccess.Mappings.LOOKUP
{
    ...
    public sealed class LUShortReportTypeMap : EntityTypeConfiguration<readShorts.Entities.LOOKUP.LUShortReportType>
    {
        public LUShortReportTypeMap()
        {
            // Primary Key
            ...
            ToTable("LOOKUP.LUShortReportType");
            // Base columns
