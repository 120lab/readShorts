namespace readShorts.DataAccess.Mappings.LOOKUP
{
    ...
    public sealed class LUSubscriptionTypeMap : EntityTypeConfiguration<readShorts.Entities.LOOKUP.LUSubscriptionType>
    {
        public LUSubscriptionTypeMap()
        {
            // Primary Key
            ...
            ToTable("LOOKUP.LUSubscriptionType");
            // Base columns
