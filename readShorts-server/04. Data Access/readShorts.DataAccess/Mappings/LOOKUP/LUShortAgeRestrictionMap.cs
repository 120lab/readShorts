namespace readShorts.DataAccess.Mappings.LOOKUP
{
    ...
    public sealed class LUShortAgeRestrictionMap : EntityTypeConfiguration<readShorts.Entities.LOOKUP.LUShortAgeRestriction>
    {
        public LUShortAgeRestrictionMap()
        {
            // Primary Key
            ...
            ToTable("LOOKUP.LUShortAgeRestriction");
            // Base columns
