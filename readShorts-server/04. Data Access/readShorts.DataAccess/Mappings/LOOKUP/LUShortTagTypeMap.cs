namespace readShorts.DataAccess.Mappings.LOOKUP
{
    ...
    public sealed class LUShortTagTypeMap : EntityTypeConfiguration<readShorts.Entities.LOOKUP.LUShortTagType>
    {
        public LUShortTagTypeMap()
        {
            // Primary Key
