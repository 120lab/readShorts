namespace readShorts.DataAccess.Mappings.LOOKUP
{
    ...
    public sealed class LUSysInterfaceLanguageMap : EntityTypeConfiguration<readShorts.Entities.LOOKUP.LUSysInterfaceLanguage>
    {
        public LUSysInterfaceLanguageMap()
        {
            // Primary Key
            ...
            ToTable("LOOKUP.LUSysInterfaceLanguage");
            // Base columns
