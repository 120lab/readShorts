namespace readShorts.DataAccess.Mappings.LOOKUP
{
    ...
    public sealed class LUUserVerificationTypeMap : EntityTypeConfiguration<readShorts.Entities.LOOKUP.LUUserVerificationType>
    {
        public LUUserVerificationTypeMap()
        {
            // Primary Key
            ...
            ToTable("LOOKUP.LUUserVerificationType");
            // Base columns
